...
type DemoAccount = {
  ...
  color: string;
  bg: string;
  // Darker override for text (name/role labels) when `color` itself doesn't
  // clear 4.5:1 on `bg`; falls back to `color` when omitted.
  textColor?: string;
};
...
const DEMO_ACCOUNTS: DemoAccount[] = [
  ...
  },
  {
    ...
    role: "Teacher",
    color: Colors.accent,
    // Colors.accent only reaches 3.98:1 on accentLight (text needs 4.5:1).
    textColor: "#B03A19",
  ...
  },
  {
    ...
    // Colors.warning only reaches 1.84:1 on warningLight (text needs 4.5:1).
    textColor: "#8F4A17",
...
export default function LoginScreen() {
  ...
  const handleRegister = async () => {
    ...
    if (!registerEmail.trim() && !registerMobile.trim()) {
    ...
    if (registerRole === "student" && !classLevel) {
      setError("Please select standard.");
      return;
    }
    if (!humanConfirm) {
    ...
    const result = await signUp({
      ...
      childRegistrationId:
        registerRole === "parent"
          ? childRegistrationId.trim().toUpperCase() || undefined
          : undefined,
      formStartedAt,
      botField: "",
    });
      ...
      >
        ...
        <View style={s.hero}>
          ...
          <View style={s.heroRow}>
            ...
            <View style={s.heroMascot}>
              <Image
                source={require("../assets/kids-play.png")}
        ...
        <View style={s.card}>
          <View style={s.modeRow}>
            ...
            >
              <Text
                style={[s.modeBtnText, mode === "login" && s.modeBtnTextActive]}
              >
                Sign In
              </Text>
            </Pressable>
            ...
            >
              <Text
                style={[
                  s.modeBtnText,
                  mode === "register" && s.modeBtnTextActive,
                ]}
              >
                Self Register
              </Text>
          ...
          <Text style={s.cardSub}>
            {mode === "login"
              ...
              : "Join ELS Academy as teacher, student, or parent"}
          </Text>
            ...
            <>
              ...
              <View style={s.fieldWrap}>
                ...
                <View style={s.roleRow}>
                  <Pressable
                    style={[
                      s.roleBtn,
                      registerRole === "student" && s.roleBtnActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        s.roleBtnText,
                        registerRole === "student" && s.roleBtnTextActive,
                      ]}
                    >
                      Student
                    </Text>
                  ...
                  <Pressable
                    style={[
                      s.roleBtn,
                      registerRole === "parent" && s.roleBtnActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        s.roleBtnText,
                        registerRole === "parent" && s.roleBtnTextActive,
                      ]}
                    >
                      Parent
                    </Text>
              ...
              {registerRole === "student" && (
                <View style={s.fieldWrap}>
                  ...
                  <Pressable
                    style={s.selectInput}
                    onPress={() => setStandardSelectorOpen(true)}
                  >
              ...
              {registerRole === "parent" && (
                <View style={s.fieldWrap}>
                  <Text style={s.fieldLabel}>
                    Child Registration ID (optional)
                  </Text>
                  <TextInput
              ...
              <View style={s.demoGrid}>
                {DEMO_ACCOUNTS.map((d) => (
                  ...
                  >
                    ...
                    <Text style={[s.demoBtnName, { color: d.textColor ?? d.color }]}>{d.label}</Text>
                    <Text style={[s.demoBtnRole, { color: d.textColor ?? d.color }]}>{d.role}</Text>
                  </AnimatedPressable>
                ))}
              </View>
            </View>
...
const s = StyleSheet.create({
  ...
  blobBlue: {
    width: 220,
    height: 220,
    backgroundColor: "rgba(74,127,224,0.12)",
    top: -80,
    left: -60,
  },
  blobCoral: {
