...
const s = StyleSheet.create({
  ...
  heroSub: { fontSize: 12, color: '#fff', fontWeight: '500', marginBottom: 4 },
  heroTitle: { fontSize: 20, color: '#fff', fontWeight: '900', lineHeight: 26, marginBottom: 14 },
  heroBtn: {
    alignSelf: 'flex-start',
    flexDirection: 'row', alignItems: 'center', gap: 4,
    // Darkening (not lightening) overlay so white button text keeps WCAG AA
    // contrast against the (already-dark) hero background behind it.
  ...
  historyCardNumText: { fontSize: 10, color: '#2D5DC9', fontWeight: '900' },
  ...
  historyCardMeta: { fontSize: 11, color: '#525C6B', marginTop: 2, fontWeight: '600' },
