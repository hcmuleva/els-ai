...
const STATUS_TAG: Record<StoryStatus, { bg: string; text: string; label: string }> = {
  draft:     { bg: '#F0F0F8', text: '#525C6B', label: 'Draft' },
            ...
            {([
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                  <Icon size={13} color={modalTab === tab ? '#2D5DC9' : '#525C6B'} />
            ...
            <ScrollView contentContainerStyle={s.tabContent}>
              ...
              <View style={s.fieldGroup}>
                ...
                <View style={s.fieldCard}>
                  ...
                  <Text style={[s.fieldInput, { color: '#525C6B', fontSize: 12 }]}>
              ...
              <View style={s.fieldGroup}>
                ...
                <View style={s.fieldCard}>
                  ...
                  <Text style={[s.fieldInput, { color: '#525C6B', fontSize: 12, marginBottom: 4 }]}>
          ...
          <View style={s.modalTabBar}>
            {([
              ...
              <Pressable key={tab} style={[s.modalTab, secModalTab === tab && s.modalTabActive]} onPress={() => setSecModalTab(tab)}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                  <Icon size={13} color={secModalTab === tab ? '#2D5DC9' : '#525C6B'} />
                      ...
                      <View style={{ flexDirection: 'row', gap: 6, marginBottom: 4 }}>
                        {([['image', ImageIcon], ['video', Video], ['audio', Mic]] as [MediaItem['kind'], any][]).map(([kind, Icon]) => (
                          ...
                          <Pressable key={kind} disabled={readOnlyEndedView} style={[s.mediaAddPill, readOnlyEndedView && { opacity: 0.5 }]}
                            ...
                            <Icon size={11} color={active ? '#1A4DA2' : '#2D5DC9'} />
                  ...
                  {editingSec.quizId ? (
                    ...
                    readOnlyEndedView ? (
                      <View style={s.fieldGroup}>
                        ...
                        <View style={s.fieldCard}>
                          <Text style={[s.fieldInput, { color: '#525C6B', fontSize: 12 }]}>No quiz attached to this section.</Text>
                        </View>
                      </View>
                    ) : (
                    <>
                      <View style={s.fieldGroup}>
                        ...
                        <Pressable style={s.fieldCard} onPress={() => { setPickerSearch(''); setPickerOpen(true); }}>
                          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                            <ListChecks size={20} color="#2D5DC9" />
                            <View style={{ flex: 1 }}>
                      ...
                      <View style={s.fieldGroup}>
                        ...
                        <Pressable style={[s.fieldCard, { borderColor: '#86BFFF', backgroundColor: '#EBF4FF' }]} onPress={() => setQuizCreatorOpen(true)}>
                          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                            <Plus size={20} color="#2D5DC9" />
                            <View style={{ flex: 1 }}>
                              <Text style={[s.fieldInput, { paddingVertical: 0, color: '#2D5DC9', fontWeight: '800' }]}>Create new quiz</Text>
                              <Text style={[s.fieldLabel, { marginTop: 2 }]}>Build a quiz inline & auto-attach</Text>
                            </View>
                            <Text style={{ color: '#2D5DC9', fontSize: 16 }}>›</Text>
                          </View>
                        </Pressable>
                      </View>
                    </>
            ...
            <View style={s.pickerOverlay}>
              ...
              <View style={s.pickerToolbar}>
                <View style={s.searchRow}>
                  ...
                  />
                  {pickerSearch !== '' && (
                    <Pressable onPress={() => setPickerSearch('')}><X size={15} color="#525C6B" /></Pressable>
                  )}
                </View>
              </View>
              {(() => {
                  ...
                  <FlatList
                        ...
                        >
                          ...
                          <View style={s.questionFooter}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                              <Trophy size={11} color="#525C6B" />
                              <Text style={{ fontSize: 11, color: '#525C6B', fontWeight: '600' }}>Quiz</Text>
                            </View>
                    ...
                    ListEmptyComponent={(
                      <View style={{ alignItems: 'center', paddingVertical: 48, gap: 8 }}>
                        ...
                        <Text style={{ fontSize: 12, color: '#525C6B', textAlign: 'center', paddingHorizontal: 32 }}>
  ...
  return (
    <View style={s.dayPickerWrap}>
      ...
      <View style={s.dayLegend}>
        <View style={s.dayLegendItem}><View style={[s.dayLegendDot, { backgroundColor: '#2D5DC9' }]} /><Text style={s.dayLegendText}>Selected</Text></View>
...
const s = StyleSheet.create({
  ...
  topSub:       { fontSize: 12, color: '#525C6B', fontWeight: '500', marginTop: 2, flexShrink: 1 },
  ...
  newBtn:       { flexDirection: 'row', alignItems: 'center', backgroundColor: '#2D5DC9', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 9 },
  ...
  historyCardMeta:   { fontSize: 12, color: '#525C6B', fontWeight: '500', paddingHorizontal: 16, marginTop: 2 },
  ...
  classMetaLabel:  { fontSize: 10, color: '#525C6B', fontWeight: '700', textTransform: 'uppercase' },
  ...
  footerBtnTextDisabled: { color: '#525C6B' },
  ...
  storyPreviewSub:       { fontSize: 13, color: '#fff' },
  ...
  storyPreviewStatLabel: { fontSize: 10, fontWeight: '700', color: '#fff', textTransform: 'uppercase' },
  storyPreviewBody:      { padding: 16, gap: 10 },
  storyPreviewMeta:      { fontSize: 12, color: '#525C70', fontWeight: '700' },
  storyPreviewEmpty:     { alignItems: 'center', paddingVertical: 20, gap: 8 },
  storyPreviewEmptyText: { fontSize: 13, color: '#525C6B', textAlign: 'center', lineHeight: 20 },
  ...
  uploadBtnText:{ fontSize: 13, fontWeight: '800', color: '#2D5DC9' },
  ...
  fileCardMeta: { fontSize: 10, color: '#525C6B', marginTop: 2, fontWeight: '700' },
  ...
  sourceToggleText: { fontSize: 11, fontWeight: '700', color: '#525C6B' },
  ...
  dayPickerHint: { fontSize: 11, color: '#525C70', fontWeight: '600', marginBottom: 8 },
  ...
  daySimpleCardSelected: { backgroundColor: '#2D5DC9', borderColor: '#3070C0' },
  ...
  // Raised opacity from 0.22 to 0.85 — the dark-blue badge text (#1A4DA2) had
  // only 2.10:1 against the subtle tint over the selected blue card.
  daySimpleBadgeSelected: { backgroundColor: 'rgba(255,255,255,0.85)' },
  daySimpleBadgeTaken: { backgroundColor: '#FCA5A5' },
  daySimpleBadgeText: { fontSize: 10, fontWeight: '800', color: '#1A4DA2' },

  dayWeekLabel: { fontSize: 10, fontWeight: '800', color: '#525C6B', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 6 },
  ...
  dayCellSelected: { backgroundColor: '#2D5DC9', borderColor: '#3070C0' },
  dayCellOccupied: { backgroundColor: '#FEE2E2', borderColor: '#FECACA' },
  dayCellDow:   { fontSize: 8, fontWeight: '800', color: '#525C6B', textTransform: 'uppercase', letterSpacing: 0.3 },
  dayCellNum:   { fontSize: 18, fontWeight: '900', color: '#1a1a2e', lineHeight: 22 },
  dayCellMon:   { fontSize: 8, fontWeight: '700', color: '#525C6B' },
  ...
  // Dark (not light) overlay — the light tint on the selected blue cell
  // dropped the white check text to 3.24:1.
  dayCellCheckBadge: { marginTop: 3, backgroundColor: 'rgba(0,0,0,0.15)', borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1 },
  ...
  dayLegendText: { fontSize: 10, color: '#525C6B', fontWeight: '700' },
  ...
  removeSectionBtnText: { fontSize: 11, fontWeight: '800', color: '#D33F13' },
  ...
  mediaAddPillText: { fontSize: 10, fontWeight: '800', color: '#2D5DC9' },
  ...
  attachPill:     { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 12, paddingVertical: 5, borderRadius: 999, backgroundColor: '#2D5DC9' },
