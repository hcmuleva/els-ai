                    ...
                    >
                      <Text
                        style={[
                          m.scoreText,
                          {
                            // darkened for WCAG AA on scorePill bg (raw values were 2.97/2.97/3.96:1)
                            color:
                              t.score >= 80
                                ? "#1B5E20"
                                : t.score >= 60
    ...
    <>
      <ScrollView style={s.screen} contentContainerStyle={s.scroll}>
        ...
        <View style={s.grid2}>
          {[
            {
              icon: <BookOpen size={20} color="#2D5DC9" />,
            ...
            {
              icon: <Flame size={20} color="#D33F13" />,
              val: `${stats.dayStreak}🔥`,
              label: "Day Streak",
              bg: "#FFE8D6",
              // Text darkened from #D33F13 (3.96:1 on this bg) to clear WCAG AA.
              color: "#B03A19",
            },
            {
              ...
              label: "Quizzes Done",
              bg: "#D6F5D6",
              // Text darkened from #7DC67A (1.75:1 on this bg) to clear WCAG AA.
              color: "#2F6B2D",
            },
            {
              ...
              label: "Total XP",
              bg: "#FFF5CC",
              // Text darkened from #E6A817 (1.92:1 on this bg) to clear WCAG AA.
              color: "#8F680C",
            },
          ].map((item) => (
            <View
            ...
            >
              ...
              >
                <ActIcon
                  type={act.type}
                  size={18}
                  color={act.type === "quiz" ? "#D33F13" : "#2D5DC9"}
                />
              </View>
...
const m = StyleSheet.create({
  ...
  sparkSub: { fontSize: 11, fontWeight: "500", color: "#525C6B", marginTop: 2 },
