        ...
        <View style={styles.sheet}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 20 }}>
              ...
              <View style={styles.previewBlock}>
                ...
                <View style={styles.controlsRow}>
                  <View style={styles.nudgeGroup}>
                    ...
                    <Pressable style={styles.nudgeBtn} onPress={() => nudge('start', -1)}><Minus size={14} color="#4A90E2" /></Pressable>
                    <TextInput
                      ...
                      returnKeyType="done"
                    />
                    <Pressable style={styles.nudgeBtn} onPress={() => nudge('start', 1)}><Plus size={14} color="#4A90E2" /></Pressable>
                  </View>
                  <View style={styles.nudgeGroup}>
                    <Text style={styles.nudgeLabel}>End</Text>
                    <Pressable style={styles.nudgeBtn} onPress={() => nudge('end', -1)}><Minus size={14} color="#4A90E2" /></Pressable>
                    <TextInput
                      style={styles.timeInput}
                      value={endText}
                      ...
                      returnKeyType="done"
                    />
                    <Pressable style={styles.nudgeBtn} onPress={() => nudge('end', 1)}><Plus size={14} color="#4A90E2" /></Pressable>
                  </View>
                </View>
            ...
            <Field label="Section title *">
              <TextInput style={styles.input} value={title} onChangeText={setTitle} placeholder="e.g. Introduction to Water Cycle" placeholderTextColor="#9A9AB0" />
            </Field>

            <Field label="Description">
              <TextInput style={[styles.input, styles.multiline]} value={description} onChangeText={setDescription} placeholder="Optional description" placeholderTextColor="#9A9AB0" multiline />
            </Field>

            <Field label="Learning objective">
              <TextInput style={[styles.input, styles.multiline]} value={learningObjective} onChangeText={setLearningObjective} placeholder="What should the student learn?" placeholderTextColor="#9A9AB0" multiline />
            </Field>
            ...
            <Field label="Category">
              <TextInput style={styles.input} value={category} onChangeText={setCategory} placeholder="e.g. Science" placeholderTextColor="#9A9AB0" />
            </Field>
...
const styles = StyleSheet.create({
  ...
  hint: { fontSize: 12, color: '#9A9AB0', marginTop: 6 },
