    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View style={styles.sheet}>
          ...
          {loading ? (
            <ActivityIndicator style={{ marginTop: 24 }} color="#4A90E2" />
          ) : (
            <FlatList
              data={filtered}
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    ...
                    {attachingId === item.id ? <ActivityIndicator color="#4A90E2" /> : null}
                  </Pressable>
                );
              }}
            />
...
const styles = StyleSheet.create({
  ...
  createBtnText: { fontSize: 13, fontWeight: '800', color: '#4A90E2' },
});
