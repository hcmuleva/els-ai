...
export default function StudentRemarkSheet({
  ...
  const overallColor = overallAvg >= 4.5 ? '#10B981' : overallAvg >= 3.5 ? '#22C55E' : overallAvg >= 2.5 ? '#F59E0B' : overallAvg >= 1 ? '#F97316' : '#525C6B';
...
const sh = StyleSheet.create({
  ...
  overallLabel:  { fontSize: 12, color: '#525C6B', fontWeight: '500' },
  ...
  closeXText:    { fontSize: 13, color: '#525C6B', fontWeight: '700' },
  ...
  sectionTabText:    { fontSize: 12, fontWeight: '600', color: '#525C6B' },
  ...
  sectionDesc:    { fontSize: 12, color: '#525C6B', fontWeight: '500', lineHeight: 18 },
  ...
  gaugeSubLabel:{ fontSize: 11, color: '#525C6B', fontWeight: '500' },
  ...
  fieldHint:     { fontSize: 11, color: '#525C6B', lineHeight: 17 },
  ...
  achievDesc:    { fontSize: 10, color: '#525C6B', lineHeight: 14 },
  ...
  emptyAchievText: { fontSize: 14, fontWeight: '700', color: '#525C6B' },

  grantedList:      { marginTop: 8, backgroundColor: '#F8F9FF', borderRadius: 14, padding: 12, gap: 6 },
  grantedListTitle: { fontSize: 11, fontWeight: '800', color: '#525C6B', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 },
  ...
  cancelBtnText:{ fontSize: 14, fontWeight: '700', color: '#525C6B' },
  saveBtn:     { flex: 2, borderRadius: 14, backgroundColor: '#2D5DC9', paddingVertical: 14, alignItems: 'center' },
