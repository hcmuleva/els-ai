    ...
    <View style={s.root}>
      ...
      <View style={s.topNav}>
        <View style={s.tabGroup}>
          ...
          >
            <Plus size={15} color={pageView === 'creator' ? '#2D5DC9' : '#525C6B'} />
          ...
          >
            <Library size={15} color={pageView === 'quiz_bank' ? '#2D5DC9' : '#525C6B'} />
          ...
          <View style={s.bankSection}>
                      ...
                      <View key={q.id} style={[s.quizCard, isMobile && { width: '100%', maxWidth: '100%' }]}>
                        ...
                        <View style={s.quizCardFooter}>
                          <View style={s.quizMetaItem}>
                            <ListChecks size={13} color="#525C6B" />
            ...
            {filteredQuizBank.length > 12 && (
              <View style={s.pageRow}>
                ...
                >
                  <ChevronLeft size={16} color={quizBankPage === 0 ? '#CBD5E1' : '#2D5DC9'} />
                ...
                >
                  ...
                  <ChevronRight size={16} color={(quizBankPage + 1) * 12 >= filteredQuizBank.length ? '#CBD5E1' : '#2D5DC9'} />
                </Pressable>
              </View>
            )}
          </View>
                ...
                <View style={s.bankFiltersCol}>
                  ...
                  <View style={s.bankSearchRow}>
                    ...
                    <Pressable style={s.selectAllBtn} onPress={handleSelectAll}>
                      <CheckSquare size={13} color="#2D5DC9" />
              ...
              {bankTab === 'question' && filteredQuestions.length > 20 && (
                <View style={s.pageRow}>
                  <Pressable
                    ...
                    disabled={bankPage === 0}
                  >
                    <ChevronLeft size={16} color={bankPage === 0 ? '#CBD5E1' : '#2D5DC9'} />
                  ...
                  >
                    ...
                    <ChevronRight size={16} color={(bankPage + 1) * 20 >= filteredQuestions.length ? '#CBD5E1' : '#2D5DC9'} />
                  </Pressable>
                </View>
              )}
            </View>
...
function HelpIconFallback({ size = 20, color = '#525C6B' }: { size?: number; color?: string }) {
...
const s = StyleSheet.create({
  ...
  heroSub: { fontSize: 13, color: '#525C6B', lineHeight: 19 },
  heroActionBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  heroActionBtnTextOutline: { color: '#2D5DC9', fontWeight: '800', fontSize: 13 },
  ...
  msgError: { backgroundColor: '#FFE8E8', borderWidth: 1, borderColor: '#D33F13' },
  ...
  quizChipText: { fontSize: 11, fontWeight: '700', color: '#4B5768' },
  ...
  quizCardDesc: { fontSize: 13, color: '#4B5768', lineHeight: 18 },
  ...
  inputGroup: { gap: 6 },
  inputLabel: { fontSize: 12, fontWeight: '700', color: '#525C6B' },
  textInput: {
  ...
  selectPlaceholder: { flex: 1, fontSize: 13, color: '#525C6B' },
  ...
  diffBtnText: { fontSize: 12, fontWeight: '600', color: '#525C6B' },
  ...
  bankTabText: { fontSize: 12, fontWeight: '600', color: '#4B5768' },
  bankTabTextActive: { fontWeight: '800', color: '#2D5DC9' },
  ...
  selectAllText: { fontSize: 12, fontWeight: '700', color: '#2D5DC9' },
  ...
  qItemMetaTag: { fontSize: 11, color: '#4B5768', backgroundColor: '#F1F5F9', borderRadius: 4, paddingHorizontal: 6, paddingVertical: 1 },
  ...
  emptyText: { fontSize: 13, color: '#525C6B', textAlign: 'center' },
  ...
  pageInfo: { fontSize: 12, color: '#525C6B', fontWeight: '600' },
