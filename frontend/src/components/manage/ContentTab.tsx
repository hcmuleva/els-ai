      ...
      <View style={c.formCardWrap}>
        ...
        {previewContents.length > 1 && (
          <View style={{ marginBottom: 10 }}>
            <Text style={{ fontSize: 10, fontWeight: '800', color: '#525C6B', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 6 }}>
                ...
                {sec.quizId ? (() => {
                  ...
                  <View style={{ flexDirection: 'row', gap: 8 }}>
                    ...
                    >
                      ...
                      <Text style={[c.quizAttachBtnText, { color: '#2D5DC9' }]}>Create new quiz</Text>
                    </Pressable>
                  </View>
                )}
              </View>
        ...
        <View style={c.cardInfo}>
          ...
          <View style={c.cardChipRow}>
            ...
            <View style={c.cardChip}>
              <LayoutList size={10} color="#3F5D8C" />
...
const c = StyleSheet.create({
  ...
  quizAttachLabel:   { fontSize: 10, fontWeight: '800', color: '#525C6B', letterSpacing: 0.5, marginBottom: 2 },
  ...
  pickerEmpty:       { textAlign: 'center', color: '#525C6B', fontSize: 13, paddingVertical: 30 },
  ...
  typeChipBtnText: { fontSize: 12, fontWeight: '600', color: '#525C6B' },
  ...
  emptyText2: { fontSize: 14, fontWeight: '700', color: '#525C6B' },
