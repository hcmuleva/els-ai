        ...
        <ScrollView style={s.scrollContent} contentContainerStyle={s.scrollInner}>
          ...
          <View style={s.summaryStatsGrid}>
            ...
            <View style={[s.statCard, { borderLeftColor: Colors.warning }]}>
              {/* Colors.warning on white is 2.06:1; darkened for the text only, border keeps the vivid tone */}
              <Text style={[s.statValue, { color: '#8F4A17' }]}>{validationReport.warningCount}</Text>
        ...
        <View style={s.progressCenteredWrap}>
          <View style={s.progressCard}>
            ...
            <View style={s.progressMetricsRow}>
              ...
              <View style={s.progressMetric}>
                {/* Colors.warning on white is 2.06:1; darkened for text-only use */}
                <Text style={[s.progressMetricValue, { color: '#8F4A17' }]}>{skippedCount}</Text>
                  ...
                  <View style={s.logColStatus}>
                    ...
                    {log.status === 'skipped' && (
                      <View style={[s.statusPill, { backgroundColor: Colors.warningLight }]}>
                        ...
                        <Text style={[s.statusPillText, { color: '#8F4A17' }]}>Skipped</Text>
                      </View>
                    )}
                  </View>
                </View>
