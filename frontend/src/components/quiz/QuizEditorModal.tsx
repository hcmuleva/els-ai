...
const s = StyleSheet.create({
  ...
  headerSub: { fontSize: 12, color: '#9A9AB0', fontWeight: '500', marginTop: 1 },
  saveBtn: { backgroundColor: '#4A90E2', borderRadius: 10, paddingHorizontal: 16, paddingVertical: 9 },
  saveBtnDisabled: { opacity: 0.5 },
  saveBtnText: { color: '#fff', fontSize: 13, fontWeight: '800' },
  submitSaveBtn: { backgroundColor: '#4A90E2', borderRadius: 10, paddingVertical: 12, alignItems: 'center', justifyContent: 'center', marginTop: 8 },
