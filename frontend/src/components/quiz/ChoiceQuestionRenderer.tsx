...
const styles = StyleSheet.create({
  ...
  tfPillSelected: { backgroundColor: '#D6EAFF', borderColor: '#2D5DC9' },
  ...
  speakerOrb: {
    ...
    backgroundColor: '#2D5DC9', alignItems: 'center', justifyContent: 'center',
    overflow: 'visible',
    shadowColor: '#2D5DC9', shadowOpacity: 0.35, shadowOffset: { width: 0, height: 6 },
  ...
  speakerHint: { fontSize: 12, fontWeight: '700', color: '#2D5DC9' },
  ...
  pillSelected: { backgroundColor: '#D6EAFF', borderColor: '#2D5DC9' },
  ...
  checkDotActive: { backgroundColor: '#2D5DC9', borderColor: '#2D5DC9' },
  ...
  inlineAudioBtn: {
    ...
    backgroundColor: '#2D5DC9', paddingHorizontal: 18, paddingVertical: 10, borderRadius: 999,
    shadowColor: '#2D5DC9', shadowOpacity: 0.3, shadowOffset: { width: 0, height: 4 },
  ...
  // ── SUBMIT BUTTON ─────────────────────────────────────────────────────────
  submitBtn: {
    backgroundColor: '#D33F13', height: 50, borderRadius: 14,
    alignItems: 'center', justifyContent: 'center', width: '100%',
    shadowColor: '#D33F13', shadowOpacity: 0.35, shadowOffset: { width: 0, height: 5 },
