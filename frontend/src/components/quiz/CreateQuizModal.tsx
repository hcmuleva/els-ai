      ...
      <View style={[s.screen, isDesktop && s.screenDesktop]}>
        ...
        <View style={s.tabBar}>
          <Pressable
            ...
            onPress={() => setTab('quiz')}
          >
            <Trophy size={14} color={tab === 'quiz' ? '#2D5DC9' : '#525C6B'} />
          ...
          >
            <HelpCircle size={14} color={tab === 'question' ? '#2D5DC9' : '#525C6B'} />
...
const s = StyleSheet.create({
  ...
  headerSub: { fontSize: 11, color: '#525C6B', fontWeight: '600', marginTop: 1 },
  ...
  tabText: { fontSize: 13, fontWeight: '800', color: '#525C6B' },
