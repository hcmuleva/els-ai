...
const QUESTION_THEMES: Record<string, QuestionTheme> = {
  ...
  fill_blank: {
    ...
    accent: '#E6A020',
    textColor: '#7A4A00',
    // accent (#E6A020) on its own 12.5%-alpha tint is only ~2.0:1; textColor passes at 6.79:1.
    badgeTextColor: '#7A4A00',
    emoji: '✍️',
  ...
  jigsaw: {
    ...
    accent: '#0EA5E9',
    textColor: '#0C4A6E',
    // accent (#0EA5E9) on its own 12.5%-alpha tint is only ~2.4:1; textColor passes at 8.35:1.
    ...
    <View style={s.card}>
      <View style={s.headerRow}>
        <View style={[s.badge, { backgroundColor: `${theme.accent}20` }]}>
          <Text style={[s.badgeText, { color: theme.badgeTextColor ?? theme.accent }]}>
