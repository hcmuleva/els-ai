    ...
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      {resolvedPromptImage ? (
        <View style={styles.promptSection}>
          ...
          <View style={[styles.promptImageCard, { borderColor: theme?.accent ?? '#2D5DC9' }]}>
      ...
      {prompt_audio && (
        <View style={styles.speakerSection}>
          ...
          <Text style={[styles.speakerHint, { color: theme?.accent ?? '#2D5DC9' }]}>
...
const styles = StyleSheet.create({
  ...
  sepLabel: { fontSize: 12, fontWeight: '700', color: '#2D5DC9', textAlign: 'center' },
