...
export const qFormS = StyleSheet.create({
  ...
  formCardWrap: { flex: 1, backgroundColor: '#fff', borderRadius: 16, padding: 16, gap: 10, borderWidth: 1, borderColor: '#E8ECF4', shadowColor: '#1a1a2e', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 2, overflow: 'hidden' },
  formCardHeader: { paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#F0F0F8', gap: 2 },
  cardTitleHeader: { fontSize: 15, fontWeight: '800', color: '#1a1a2e' },
  cardSubHeader: { fontSize: 11, fontWeight: '500', color: '#64748B' },
  ...
  tabContent: { padding: 16, gap: 16, paddingBottom: 40, width: '100%', maxWidth: 960, alignSelf: 'center' },
  group: { gap: 8 },
  ...
  logicoTwoColContainer: { flexDirection: 'row', alignItems: 'flex-start', gap: 16, marginTop: 10 },
  logicoLeftCol: { flex: 1 },
  logicoRightCol: { width: 380, maxWidth: '42%', backgroundColor: '#F8FAFC', borderRadius: 14, borderWidth: 1, borderColor: '#E2E8F0', padding: 14, gap: 10 },
  logicoCardDesktop: { width: '48%', borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 10, padding: 10, gap: 8, backgroundColor: '#FFFFFF' },
  logicoImageCardHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 },
  logicoImageCardTitle: { fontSize: 13, fontWeight: '800', color: '#334155', textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  logicoPreviewContainer: { position: 'relative', borderRadius: 12, overflow: 'hidden', borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#FFFFFF' },
  logicoWorksheetPreviewDesktop: { width: '100%', height: 420, backgroundColor: '#FFFFFF' },
  logicoNoImageCard: { padding: 24, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F1F5F9', borderRadius: 10, borderWidth: 1, borderColor: '#E2E8F0', gap: 12 },
  logicoNoImageText: { fontSize: 13, color: '#4B5768', textAlign: 'center' },
  uploadSwitchBtn: { backgroundColor: '#7B4FCA', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 },
  uploadSwitchBtnText: { color: '#FFFFFF', fontSize: 12, fontWeight: '700' },
  ...
  modalImageBody: { width: '100%', maxWidth: 960, height: '82%', alignItems: 'center', justifyContent: 'center' },
  expandedImage: { width: '100%', height: '100%' },

  logicoOverlayCardWrap: { position: 'relative', aspectRatio: 526 / 725, borderRadius: 12, overflow: 'hidden', borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#FFFFFF', alignSelf: 'center' },
  logicoOverlayImage: { width: '100%', height: '100%' },
  logicoOverlayRailContainer: { position: 'absolute', top: 0, bottom: 0, right: 0, width: '23%', backgroundColor: 'rgba(15, 23, 42, 0.16)', borderLeftWidth: 1, borderLeftColor: 'rgba(255, 255, 255, 0.35)', flexDirection: 'column', alignItems: 'center' },
  logicoOverlayHeaderSpacer: { height: '8.8%' },
  logicoOverlaySlotColumn: { flex: 1, width: '100%', flexDirection: 'column', justifyContent: 'flex-start', gap: 2, paddingVertical: '1%' },
  logicoOverlaySlotRow: { height: '9.3%', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 3 },
  logicoPositionBadge: { width: 22, height: 22, borderRadius: 11, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#FFFFFF', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.4, shadowRadius: 2, elevation: 3 },
  logicoPositionBadgeUnmapped: { backgroundColor: '#475569' },
  logicoPositionBadgeMapped: { backgroundColor: '#7B4FCA' },
  logicoPositionBadgeText: { color: '#FFFFFF', fontSize: 10, fontWeight: '900' },
  logicoOverlayMappedPill: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255, 255, 255, 0.95)', padding: 1.5, borderRadius: 10, borderWidth: 1, borderColor: '#E2E8F0' },
  logicoHeaderActions: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  logicoToggleBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#F1F5F9', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, borderWidth: 1, borderColor: '#CBD5E1' },
  logicoToggleBtnActive: { backgroundColor: '#EDE4FF', borderColor: '#C7D2FE' },
  logicoToggleBtnText: { fontSize: 11, fontWeight: '700', color: '#475569' },
  logicoToggleBtnTextActive: { color: '#7B4FCA' },

  previewCard: { backgroundColor: '#fff', borderRadius: 20, borderWidth: 1, borderColor: '#E8ECF4', overflow: 'hidden' },
...
export const fbS = StyleSheet.create({
  ...
  previewLabel: { fontSize: 9, fontWeight: '800', color: '#2D5DC9', letterSpacing: 1, marginBottom: 8, textTransform: 'uppercase' },
...
export const mmS = StyleSheet.create({
  ...
  pairCard: { backgroundColor: '#F8F9FF', borderRadius: 10, borderWidth: 1, borderColor: '#E8ECF4', alignItems: 'center', justifyContent: 'center', paddingVertical: 6, paddingHorizontal: 2, gap: 3 },
  pairCardEmpty: { borderStyle: 'dashed', borderColor: '#CBD5E1', backgroundColor: '#FAFBFF' },
  pairImgPlaceholder: { backgroundColor: '#EEF0FA', alignItems: 'center', justifyContent: 'center' },
  pairImgPlaceholderText: { fontSize: 18, color: '#94A3B8', fontWeight: '400' },
  pairLabel: { fontSize: 9, fontWeight: '700', color: '#1a1a2e', textAlign: 'center', paddingHorizontal: 2 },
  ...
  assetCell: { alignItems: 'center', backgroundColor: '#F8F9FF', borderRadius: 12, borderWidth: 1, borderColor: '#E8ECF4', padding: 8, gap: 5, overflow: 'hidden' },
  assetCellCurrent: { borderColor: '#7B4FCA', backgroundColor: '#F3E8FF', borderWidth: 1.5 },
  assetCellUsed: { opacity: 0.32 },
  assetLabel: { fontSize: 10, fontWeight: '700', color: '#1a1a2e', textAlign: 'center' },
  assetCurrentBadge: { position: 'absolute', top: 4, right: 4, backgroundColor: '#7B4FCA', borderRadius: 6, width: 14, height: 14, alignItems: 'center', justifyContent: 'center' },
  assetCurrentBadgeText: { color: '#fff', fontSize: 8, fontWeight: '900' },
});
