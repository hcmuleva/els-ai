...
export default function DynamicQuizPanel({ api, activeSectionId, autoOpen, onQuizCompleted, onRendererOpenChange }: Props) {
  ...
  if (!quizId) {
    return (
      <View style={styles.panel}>
        <HelpCircle size={20} color="#9A9AB0" />
...
const styles = StyleSheet.create({
  ...
  btn: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#4A90E2', borderRadius: 999, paddingHorizontal: 16, paddingVertical: 10 },
