    ...
    <View style={ts.container}>
      ...
      <View style={ts.viewSwitcher}>
        <Pressable style={[ts.viewBtn, view === 'recent' && ts.viewBtnActive]} onPress={() => setView('recent')}>
          <Clock size={13} color={view === 'recent' ? '#2D5DC9' : '#525C6B'} />
        ...
        <Pressable style={[ts.viewBtn, view === 'students' && ts.viewBtnActive]} onPress={() => setView('students')}>
          <Users size={13} color={view === 'students' ? '#2D5DC9' : '#525C6B'} />
              ...
              <Pressable key={thread.id} style={ts.threadCard} onPress={() => openThread(thread.id)}>
                <View style={ts.threadRow}>
                    ...
                    <View style={{ flexDirection: 'row', gap: 4, marginBottom: 2, flexWrap: 'wrap' }}>
                      {thread.category && (
                        <View style={{ paddingHorizontal: 5, paddingVertical: 1, borderRadius: 4, backgroundColor: thread.category === 'academic' ? '#E3F2FD' : '#FFF3E0' }}>
                          <Text style={{ fontSize: 9, fontWeight: '800', color: thread.category === 'academic' ? '#1976D2' : '#B23D00' }}>
                  ...
                  <View style={ts.threadMeta}>
                    ...
                    <View style={[ts.statusDot, { backgroundColor: thread.status === 'open' ? '#4CAF50' : '#525C6B' }]} />
                  </View>
                </View>
              </Pressable>
            ))
            ...
            <>
              ...
              {studentThreads.length === 0 ? (
                ...
                studentThreads.map((thread) => (
                  <Pressable key={thread.id} style={ts.threadCard} onPress={() => openThread(thread.id)}>
                    <View style={ts.threadRow}>
                      <MessageCircle size={16} color={thread.unreadCount > 0 ? '#2D5DC9' : '#525C6B'} />
                      ...
                      <View style={{ flexDirection: 'row', gap: 6 }}>
                        {([
                          ...
                          <Pressable
                            ...
                            style={{ paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, backgroundColor: replyType === key ? '#2D5DC9' : '#F0F4FF' }}
                          >
...
const ts = StyleSheet.create({
  ...
  viewBtnText: { fontSize: 12, fontWeight: '700', color: '#525C6B' },
  viewBtnTextActive: { color: '#2D5DC9', fontWeight: '800' },
  ...
  filterLabel: { fontSize: 11, fontWeight: '700', color: '#525C6B', textTransform: 'uppercase', letterSpacing: 0.4 },
  ...
  classChipActive: { backgroundColor: '#D6EAFF', borderColor: '#2D5DC9' },
  ...
  studentMeta: { fontSize: 10, color: '#525C6B', fontWeight: '500' },
  ...
  // Student detail
  backLink: { fontSize: 12, fontWeight: '700', color: '#2D5DC9' },
  ...
  sendFeedbackBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#2D5DC9', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8 },
  ...
  subSectionTitle: { fontSize: 11, fontWeight: '800', color: '#525C6B', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 10 },
  emptySmall: { fontSize: 12, color: '#525C6B', fontStyle: 'italic', paddingVertical: 4 },
  feedbackCard: { backgroundColor: '#F8F9FF', borderRadius: 12, padding: 12, gap: 4 },
  feedbackText: { fontSize: 13, color: '#1a1a2e', lineHeight: 20 },
  feedbackDate: { fontSize: 10, color: '#525C6B', fontWeight: '500' },
  ...
  threadAvatarUnread: { backgroundColor: '#D6EAFF', borderWidth: 2, borderColor: '#2D5DC9' },
  threadAvatarText: { fontSize: 14, fontWeight: '900', color: '#2D5DC9' },
  threadTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  threadSubject: { fontSize: 13, fontWeight: '800', color: '#1a1a2e', flex: 1 },
  threadStudentName: { fontSize: 11, color: '#525C6B', fontWeight: '600' },
  ...
  modalSub: { fontSize: 11, color: '#525C6B', fontWeight: '500', marginTop: 2 },
  ...
  replyBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#2D5DC9', alignItems: 'center', justifyContent: 'center' },
