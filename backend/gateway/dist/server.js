...
import { buildInternalHeaders, verifyJwtPayload } from '@els-ai/internal-auth';
config();
...
app.use('/video-sections', makeProxy(CONTENT_SERVICE_URL, '/video-sections'));
...
app.use('/feedback', makeProxy(AUTH_SERVICE_URL, '/feedback'));
