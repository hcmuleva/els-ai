...
import {
  topicsRouter,
  catalogRouter,
  studentsRouter as topicStudentsRouter,
} from './services/topic/routes/topics.js';
import { contentRouter } from './services/content/routes/content.js';
import {
  videoContentRouter,
  videoSectionsRouter,
} from './services/content/routes/video-sections.js';
import { bookmarksRouter } from './services/content/routes/bookmarks.js';
import {
  questionsRouter,
  questionBankRouter,
} from './services/question-bank/routes/questions.js';
