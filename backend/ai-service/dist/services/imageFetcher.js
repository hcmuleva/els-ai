...
export async function fetchAndUploadTopicImage(topic, organizationId) {
    ...
    try {
        ...
        const searchUrl = `https://commons.wikimedia.org/w/api.php?action=query&generator=search&gsrnamespace=6&gsrsearch=${encodeURIComponent(cleanTopic)}&gsrlimit=12&prop=imageinfo&iiprop=url|mime&format=json&origin=*`;
