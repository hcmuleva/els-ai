...
export async function generateQuestions(
  params: z.infer<typeof QuestionParams>,
  ...
  if (qType === "fill_blank") {
    const output = await generateJson<{
      ...
      system:
        "You are an expert exam-question writer. Reply with ONLY JSON: " +
  ...
  if (qType === "memory_match") {
    const output = await generateJson<{
      ...
      system:
        "You are an expert question writer. Reply with ONLY JSON: " +
  ...
  const output = await generateJson<{
    ...
    system:
      "You are an expert exam-question writer. Reply with ONLY JSON matching: " +
